...
urlpatterns = [
    ...
    #approach 2
    path('admin/view/<type:str>' views_admin.list_object, name='object_list'),
    path('admin/add/<type:str>' views_admin.add_object, name='add_object'),
    path('admin/edit/<type:str>/<id:int>' views_admin.edit_object, name='edit_object'),
    path('admin/delete/<type:str>/<id:int>' views_admin.delete_object, name='delete_object'),
]